...
const CoinPage = () => {
  ...
  return (
    <div className="rounded-div my-12 py-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          <div className="flex justify-around p-8 text-accent">
            <FaTwitter size={30} className="cursor-pointer hover:scale-105" />
            <FaFacebook size={30} className="cursor-pointer hover:scale-105" />
      ...
      {/* Description */}
      <div className="py-4">
        <p className="text-xl font-bold py-2">About {coin.name}</p>
        <p
